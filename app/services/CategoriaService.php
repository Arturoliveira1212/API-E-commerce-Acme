...
class CategoriaService extends Service
{
    ...
    public const TAMANHO_MINIMO_DESCRICAO = 5;
    public const TAMANHO_MAXIMO_DESCRICAO = 500;
    ...
    private function validarNome(Categoria $categoria, int $operacaoObjeto, array &$erro)
    {
        ...
        } elseif ($operacaoObjeto == OperacaoObjeto::CADASTRAR && $this->getDao()->existe('nome', $categoria->getNome())) {
